...
Geometry is always *rebuilt* from `params`, and meshes are never scaled, so undo,
...
Spanish and English, switchable live from the flag selector, with no reload and the design
